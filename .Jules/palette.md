...
## 2026-06-16 - Enhance keyboard shortcut discoverability
**Learning:** Adding explicit visual hints (like "Press '/'") directly to input placeholders improves global shortcut discoverability without cluttering the UI.
**Action:** Incorporate explicit visual hints directly into input placeholders when implementing global keyboard shortcuts.
