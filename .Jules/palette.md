...
## 2026-06-12 - Global Search Shortcut Discoverability
**Learning:** Global keyboard shortcuts (like '/' for search) are powerful for power users, but completely invisible by default. Without a visual hint, the feature is unlikely to be discovered.
**Action:** When adding global keyboard shortcuts, incorporate explicit visual hints directly into input placeholders (e.g., `Search (Press '/')...`) to improve discoverability without cluttering the UI.
