...
## 2026-09-18 - Escape key binding to clear filters
**Learning:** When using Escape to reset search filters, it's important to also blur the input to prevent accidental re-typing.
**Action:** Add `$(e.target).blur()` to Escape listeners and visually hint the shortcut.
